...
There is a shortcut.  You can use C<Math::Units::PhysicalValue "PV"> to export
...
You can also choose C<pv()> for this.

=head2 $StrictTypes

Presently, by default, you can create C<$wierd_units = PV "5 Saxons";> without any
